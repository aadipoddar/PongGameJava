...
public class Window extends JFrame implements Runnable
{
    ...
    public Window()
    {
        ...
        playerOne = new Rect(Constants.HZ_PADDLING , 40 , Constants.PADDLE_WIDTH , Constants.PADDLE_HEIGHT, Constants.PADDLE_COLOR);
        playerController = new PlayerController(playerOne, keyListener);
        
        ai = new Rect(Constants.SCREEN_WIDTH - Constants.PADDLE_WIDTH - Constants.HZ_PADDLING , 40 , Constants.PADDLE_WIDTH , Constants.PADDLE_HEIGHT, Constants.PADDLE_COLOR);
